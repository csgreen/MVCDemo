...
#import "CookieListViewController.h"

@interface CookieListViewController ()

@end

@implementation CookieListViewController
...
- (void)viewDidLoad
{
    ...
    CSGCookie *cookie = [[CSGCookie alloc] init];
    ...
    CSGCookie *cookie2 = [[CSGCookie alloc] init];
    cookie2.name = @"Mac Nut";
    cookie2.price = [NSDecimalNumber decimalNumberWithString:@"1.89"];
    cookie2.ingredients = @[@"nuts", @"milk", @"butter",@"magic"];
    cookie2.glutenFree = FALSE;
    
    _cookies = [NSMutableArray arrayWithObjects: cookie, cookie2, nil];
